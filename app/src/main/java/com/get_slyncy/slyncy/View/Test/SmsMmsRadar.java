...
//            final Cursor mmsIncursor = getContentResolver().query(uri, null, null, null, null);
...
//                if (type == 1)
//                {
//                    final Cursor readCursor = contentResolver
...
//                        readId = readCursor.getInt(readCursor.getColumnIndex("_id"));
//                        final int readThreadId = readCursor.getInt(readCursor.getColumnIndex("thread_id"));
//                        final int finalReadId = readId;
//                        new Thread(new Runnable()
//                        {
//                            @Override
//                            public void run()
//                            {
//                                if (read == 1 && mmsStorage.isUnread(finalReadId))
//                                {
//                                    mmsStorage.markRead(finalReadId);
//                                    Log.v("MMS LISTENER", finalReadId + " marked as read");
//                                    ClientCommunicator.markThreadAsRead(readThreadId);
//                                }
//                                else if (read == 1 && !mmsStorage.isAdded(finalReadId))
//                                {
//                                    mmsStorage.addNewMessage(finalReadId, true);
//                                    getReceivedMmsInfo(readCursor);
//                                }
//                                readCursor.close();
//                            }
//                        }).start();
...
//                        final int read = readCursor.getInt(readCursor.getColumnIndex("read"));
//                        readId = readCursor.getInt(readCursor.getColumnIndex("_id"));
//                        final int threadReadId = readCursor.getInt(readCursor.getColumnIndex("thread_id"));
//                        final int finalReadId = readId;
//                        new Thread(new Runnable()
//                        {
//                            @Override
//                            public void run()
//                            {
//                                if (read == 1 && smsStorage.isUnread(finalReadId))
//                                {
//                                    smsStorage.markRead(finalReadId);
//                                    Log.v("SMS LISTENER", finalReadId + " marked as read");
//                                    ClientCommunicator.markThreadAsRead(threadReadId);
//                                }
//                                else if (read == 1 && !smsStorage.isAdded(finalReadId))
//                                {
//
//                                    smsStorage.addNewMessage(finalReadId, true);
//                                    getReceivedSmsInfo(readCursor);
//                                }
//                                readCursor.close();
//                            }
//                        }).start();
...
//            final SlyncyMessage message = MessageDbUtility.getMmsMessage(cursor, contentResolver);
...
////
////            Cursor c = getContentResolver().query(Uri.parse("content://mms/" + mms_id + "/addr"), new String[]{"*"}, null, null, null);
////            message.setNumbers(MessageDbUtility.getMmsAddresses(message, c));
...
//
//            int mtype = cursor.getInt(cursor.getColumnIndex("msg_box"));
//            final SlyncyMessage message = MessageDbUtility.getMmsMessage(cursor, getContentResolver());
////            new SlyncyMessage();
//            String str = "";
////
////
